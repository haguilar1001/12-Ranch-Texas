...
import { esFinDeSemanaOFestivo, diaTarifaDe } from "../lib/tarifas/diaTarifa";
...
describe("día de tarifa (semana vs. fin de semana/festivo)", () => {
  ...
  it("sábado y domingo son fin de semana", () => {
    ...
    expect(diaTarifaDe(bogota("2026-09-19"))).toBe("fin_semana_festivo");
  });
  ...
  it("un festivo colombiano entre semana cuenta como fin de semana/festivo", () => {
    ...
    expect(diaTarifaDe(bogota("2026-07-20"))).toBe("fin_semana_festivo");
  });
